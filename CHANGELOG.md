...
## [v0.4.2](https://github.com/k1LoW/roots/compare/v0.4.1...v0.4.2) - 2026-06-21
...
- chore(deps): bump github.com/mattn/go-isatty from 0.0.20 to 0.0.21 in the dependencies group by @dependabot[bot] in https://github.com/k1LoW/roots/pull/32
- chore(deps): bump actions/checkout from 6 to 7 in the dependencies group by @dependabot[bot] in https://github.com/k1LoW/roots/pull/35
- chore(deps): bump the dependencies group across 1 directory with 2 updates by @dependabot[bot] in https://github.com/k1LoW/roots/pull/34
